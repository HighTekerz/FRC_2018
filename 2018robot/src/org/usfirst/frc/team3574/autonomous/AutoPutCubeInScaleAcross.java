...
public class AutoPutCubeInScaleAcross extends CommandGroup {
    ...
    public AutoPutCubeInScaleAcross(double degreeToTurnTo) {
        addSequential(new DriveByInches(0, movementSpeed)); // insert the distance needed to travel to near scale. 288 = distance between alliance station and close side of scale plate
